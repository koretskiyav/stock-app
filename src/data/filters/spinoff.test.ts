...
describe("isSpinoffAction", () => {
  ...
  it("should return true for valid spinoff descriptions with Data header", () => {
    expect(isSpinoffAction(createAction("Data", "MMM(US88579Y1010) Spinoff  1 for 4 (SOLV, SOLVENTUM CORP-W/I, US83444M1018)"))).toBe(true);
  });

  it("should return false if header is not Data", () => {
    expect(isSpinoffAction(createAction("Header", "MMM(US88579Y1010) Spinoff  1 for 4 (SOLV, SOLVENTUM CORP-W/I, US83444M1018)"))).toBe(false);
  });
